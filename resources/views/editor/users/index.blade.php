                                                        ...
                                                        <tbody>
                                                            @foreach($users as $key => $user_get)
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td style="font-size: 12px" class="sorting_1"><a href="{{ route('users.show', ['user_id' => $user_get->id]) }}">{{ $user_get->name }}</a> </td>
...
{{--                                                                                <form action="{{ route('users.destroy', ['user_id' => $user_get->id]) }}" method="post">--}}
{{--                                                                                    @csrf--}}
{{--                                                                                    @method('DELETE')--}}
{{--                                                                                    <button type="submit" class="btn btn-outline-primary btn-sm delete_user" style="font-size: 10px" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Удалить"><i class="fa-solid fa-trash"></i></button>--}}
{{--                                                                                </form>--}}
                                                                            @endif
                                                                        </div>
                                                                    </td>
