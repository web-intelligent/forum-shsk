        ...
        <div class="container">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Регистрация участников форума</h4>
                </div>
                <div class="page-category">
                    <div class="row">
                        <div class="col-sm-12 col-lg-3">
                            <aside style="position: sticky; top: 40px">
                                <div class="card card-stats card-round">
                                    <div class="card-body">
                                        <h4 class="mb-4 text-center">Статистика</h4>
                                        <div class="mb-3">Общее кол-во: {{ $statistic['people_total_amount'] }}</div>
                                        <div class="mb-3">Кол-во выданных комплектов: <span id="docs_confirm_amount">{{ $statistic['docs_confirm_amount'] }}</span></div>
                                        <div class="mb-3">Кол-во прибывших участников: <span id="income_confirm_amount">{{ $statistic['income_confirm_amount'] }}</span></div>
                                    </div>
                                </div>
                            </aside>
                        </div>
                        <div class="col-sm-12 col-lg-9">
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <h4 class="mb-4 text-center">Список участников, приезжающих на мероприятие</h4>
                                    <div class="table-responsive" id="register_user_income_table">
                                                                ...
                                                                <td style="font-size: 12px">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        @if($user_get->income == 1)
                                                                            <a data-user-id="{{ $user_get->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Отменить подтверждение приезда" href="{{ route('user.income.register.income', ['user_id' => $user_get->id]) }}" class="btn btn-outline-success btn-sm income_confirm" style="font-size: 10px"><i class="fa-solid fa-check-circle"></i></a>
                                                                        @else
                                                                            <a data-user-id="{{ $user_get->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Подтверждение приезда" href="{{ route('user.income.register.income', ['user_id' => $user_get->id]) }}" class="btn btn-outline-primary btn-sm income_confirm" style="font-size: 10px"><i class="fa-solid fa-car"></i></a>
                                                                        @endif

                                                                        @if($user_get->docs == 1)
                                                                            <a data-user-id="{{ $user_get->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Выдача комплекта документов" href="#" class="btn btn-outline-success btn-sm docs_confirm" style="font-size: 10px"><i class="fa-solid fa-check-circle"></i></a>
                                                                        @else
