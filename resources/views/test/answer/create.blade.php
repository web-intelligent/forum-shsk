        ...
        <div class="container ">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Добавление ответа на вопрос "{{ $question->question }}"</h4>
                </div>
                <div>
                    ...
                    <div class="col-sm-12 col-lg-4 offset-sm-0 offset-lg-4 bg-white p-4 rounded-2">
                        <form action="{{ route('answer.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="answer" rows="5" placeholder="Пример ответа" class="form-control"></textarea>
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="right" value="1">
                                <label class="form-check-label" for="flexSwitchCheckChecked">Верный ответ</label>
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-sn btn-primary">Добавить ответ</button>
                            </div>
                        </form>
                    </div>
                </div>
